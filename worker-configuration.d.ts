/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: ecbd45f2d5c55945a9bd078211250dae)
// Runtime types generated with workerd@1.20260801.1 2026-05-22 nodejs_compat
interface __BaseEnv_Env {
	PERSONALIZED_STORY_ART_BUCKET: R2Bucket;
	DB: D1Database;
	EVALUATE_RATE_LIMITER: RateLimit;
	LEARNER_PROFILE_TRANSCRIPTION_RATE_LIMITER: RateLimit;
	LEARNER_PROFILE_ENRICHMENT_RATE_LIMITER: RateLimit;
	LESSON_GENERATION_RATE_LIMITER: RateLimit;
	PERSONALIZED_STORY_ART_RATE_LIMITER: RateLimit;
	GUARDIAN_UNLOCK_RATE_LIMITER: RateLimit;
	AI: Ai;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MULTI_LEARNER_PROFILES_ENABLED" | "REALTIME_CONVERSATIONS_ENABLED" | "PERSONALIZED_STORY_ART_ENABLED" | "PERSONALIZED_STORY_ART_DATA_APPROVED">> {}
}
