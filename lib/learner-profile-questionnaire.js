...
export const LEARNER_PROFILE_ACKNOWLEDGMENT_TEXT = "Thank you!";
export const LEARNER_PROFILE_ACKNOWLEDGMENT_AUDIO_ID = "peppa-thank-you";
...
export function validateLearnerProfileQuestionnaire(source) {
  ...
  for (const questionValue of questions) {
    ...
    if (
      ...
      question.fallbackAcknowledgment !==
      ...
      !CANONICAL_FIELDS.has(
        /** @type {"name" | "age" | null} */ (question.canonicalField),
      ) ||
