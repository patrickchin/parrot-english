...
// Child speech recognition often drops short function words. This activity is
// practice, not an exam, so borderline transcripts should favor encouragement.
export const YOUNG_LEARNER_SIMILARITY_THRESHOLD = 0.65;
...
export function scoreSpeechTranscript(transcript, targetText) {
  ...
  const outcome =
    similarity >= YOUNG_LEARNER_SIMILARITY_THRESHOLD
      ? "correct"
      : "incorrect";
