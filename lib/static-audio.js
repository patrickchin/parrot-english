...
/** @param {readonly { items: readonly { labelAudio: { id: string, source: string, text: string }, promptAudio: { id: string, source: string, text: string } }[] }[]} categories */
export function createWordGameAudioLines(categories) {
...
const WORD_GAME_AUDIO_LINES = {
  ...createWordGameAudioLines(WORD_GAME_CATEGORIES),
  [WORD_GAME_RETRY_AUDIO.id]: createWordGameAudioLine(
    WORD_GAME_RETRY_AUDIO,
    "gentle, upbeat encouragement for a young child",
  )[1],
  [WORD_GAME_COMPLETE_AUDIO.id]: createWordGameAudioLine(
    WORD_GAME_COMPLETE_AUDIO,
