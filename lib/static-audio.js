 ...
 * @returns {[string, StaticAudioLine]}
 */
function createStoryNarrationLine(id, text, ttsText) {
  return [
    id,
    {
      speaker: "narrator",
...
/** @type {Record<string, StaticAudioLine>} */
const STORY_AUDIO_LINES = Object.fromEntries([
  createStoryNarrationLine(
    "story-lantern-trail-the-garden-gate",
    "At sunset, Pip the green parrot heard a tiny voice by the garden gate. “I’m Flicker,” said a little firefly. “The wind blew me away from my family.” Pip opened his wings. “We’ll follow your glow and find the lantern tree.” Glow, little lantern, show us the way!",
    "[warm, magical storytelling] At sunset, Pip the green parrot heard a tiny voice by the garden gate. [small and worried] “I’m Flicker,” said a little firefly. “The wind blew me away from my family.” [kind and brave] Pip opened his wings. “We’ll follow your glow and find the lantern tree.” [brightly inviting] Glow, little lantern, show us the way!",
  ),
  createStoryNarrationLine(
    "story-lantern-trail-the-moonlit-stream",
    "The trail reached a stream where round stones winked in the moonlight. Flicker lit the first stone, and Pip hopped after him—tip, tap, tip! Together they crossed without wetting a feather. Glow, little lantern, show us the way!",
    "[playful, rhythmic storytelling] The trail reached a stream where round stones winked in the moonlight. Flicker lit the first stone, and Pip hopped after him—tip, tap, tip! Together they crossed without wetting a feather. [brightly inviting] Glow, little lantern, show us the way!",
  ),
  createStoryNarrationLine(
    "story-lantern-trail-the-rain-leaf",
    "Soft rain began to patter. Pip lifted a giant leaf over them like an umbrella, but Flicker’s light grew dim. Pip stayed close until the warm glow shone again. Glow, little lantern, show us the way!",
    "[gentle storytelling] Soft rain began to patter. Pip lifted a giant leaf over them like an umbrella, but Flicker’s light grew dim. [softly reassuring] Pip stayed close until the warm glow shone again. [brightly inviting] Glow, little lantern, show us the way!",
  ),
  createStoryNarrationLine(
    "story-lantern-trail-the-windy-sunflowers",
    "A gust whooshed through the sleeping sunflowers and spun Flicker in circles. Pip cupped his wings around his little friend. When the wind passed, a golden trail twinkled ahead. Glow, little lantern, show us the way!",
    "[lively storytelling] A gust whooshed through the sleeping sunflowers and spun Flicker in circles. [warmly] Pip cupped his wings around his little friend. When the wind passed, a golden trail twinkled ahead. [brightly inviting] Glow, little lantern, show us the way!",
  ),
  createStoryNarrationLine(
    "story-lantern-trail-the-lantern-tree",
    "The trail ended at an old lantern tree. Dozens of fireflies danced from the hollow, and Flicker’s family wrapped him in a warm, sparkling hug. Pip cheered as the whole tree lit up. Welcome home, Flicker!",
    "[joyful, wondrous storytelling] The trail ended at an old lantern tree. Dozens of fireflies danced from the hollow, and Flicker’s family wrapped him in a warm, sparkling hug. Pip cheered as the whole tree lit up. [celebrating] Welcome home, Flicker!",
  ),
  createStoryNarrationLine(
    "story-lantern-trail-one-last-glow",
    "Flicker guided Pip back to his cosy tree house. One tiny light hovered outside the round window until Pip was tucked beneath his blanket. Then Flicker blinked once, twice, and floated home beneath the moon. Good night, little lantern.",
    "[soft bedtime storytelling] Flicker guided Pip back to his cosy tree house. One tiny light hovered outside the round window until Pip was tucked beneath his blanket. [gently] Then Flicker blinked once, twice, and floated home beneath the moon. [whispering warmly] Good night, little lantern.",
  ),
]);
