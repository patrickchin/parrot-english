...
/** @param {readonly { items: readonly { labelAudio: { id: string, source: string, text: string }, promptAudio: { id: string, source: string, text: string } }[] }[]} categories @param {{ successAudio: { id: string, source: string, text: string }, retryAudio: { id: string, source: string, text: string }, completeAudio: { id: string, source: string, text: string } } | undefined} [player] */
export function createWordGameAudioLines(categories, player) {
  ...
  if (player) {
    wordGameAudioById.set(player.successAudio.id, {
      speaker: "narrator",
      lang: "en-US",
      src: player.successAudio.source,
      text: player.successAudio.text,
    });
    wordGameAudioById.set(
...
const WORD_GAME_AUDIO_LINES = createWordGameAudioLines(WORD_GAME_CATEGORIES, {
  successAudio: WORD_GAME_SUCCESS_AUDIO,
