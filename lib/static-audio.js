...
export const STATIC_AUDIO_LINES = {
  "onboarding-v2-name": {
    speaker: "peppa",
    lang: "en-US",
    src: `${STATIC_AUDIO_BASE_PATH}/onboarding-v2-name.mp3`,
  ...
  "onboarding-v2-age": {
    speaker: "peppa",
    lang: "en-US",
    src: `${STATIC_AUDIO_BASE_PATH}/onboarding-v2-age.mp3`,
    text: "How old are you?",
    style: "character",
    voiceStyle: "energetic-character",
    ttsText: "[curious and cheerful] How old are you?",
  },
  "onboarding-v2-cartoons": {
    speaker: "peppa",
    lang: "en-US",
    src: `${STATIC_AUDIO_BASE_PATH}/onboarding-v2-cartoons.mp3`,
    text: "What cartoons do you like?",
    style: "character",
    voiceStyle: "energetic-character",
    ttsText: "[excited and curious] What cartoons do you like?",
  },
  "onboarding-v2-animals": {
    speaker: "peppa",
    lang: "en-US",
    src: `${STATIC_AUDIO_BASE_PATH}/onboarding-v2-animals.mp3`,
  ...
  "onboarding-v2-fun": {
    speaker: "peppa",
    lang: "en-US",
    src: `${STATIC_AUDIO_BASE_PATH}/onboarding-v2-fun.mp3`,
    text: "What do you like doing for fun?",
    style: "character",
    voiceStyle: "energetic-character",
    ttsText: "[bright and interested] What do you like doing for fun?",
  },
  "onboarding-v2-stories": {
    speaker: "peppa",
    lang: "en-US",
    src: `${STATIC_AUDIO_BASE_PATH}/onboarding-v2-stories.mp3`,
