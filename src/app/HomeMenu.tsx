...
const LEARNING_PATHS: readonly LearningPath[] = [
  ...
  },
  {
    ...
    imageHeight: 384,
    imageSrc: "https://media.parrotbook.com/assets/v2/characters/peppa/peppa-talking-384.webp",
    imageWidth: 384,
    label: "Talk to Peppa",
    tone: "navy",
    to: "/talk-to-peppa",
  },
  {
    ...
    imageHeight: 512,
    imageSrc: "https://media.parrotbook.com/assets/v2/story-pages/the-red-ball-my-red-ball.webp",
    imageWidth: 768,
    label: "Story time",
    tone: "blue",
    to: "/stories",
