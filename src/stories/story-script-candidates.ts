...
export const STORY_SCRIPT_CANDIDATES: readonly Story[] = [
  ...
  makePrototypeStory({
    id: "the-lantern-trail-original",
    title: "The Lantern Trail — Original",
    category: "Original baseline",
    durationMinutes: 4,
    level: "original-baseline",
    summary:
      "Keep the first, vocabulary-rich Pip and Flicker story as the comparison baseline.",
    targetWords: ["glow", "trail", "stream", "rain", "wind", "home"],
    assumedKnownWords: [
      "after",
      "ahead",
      "around",
    ...
    coverPrompt:
      "Pip and Flicker crossing a moonlit stream toward a glowing lantern tree",
    completionText: "Good night, little lantern.",
    promptExperiment: {
      exactRefrain: "Glow, little lantern, show us the way!",
      focus: "Original uncontrolled baseline",
      instruction:
        "Preserve the first production script verbatim as a comparison baseline. Do not simplify its vocabulary, imagery, sentence length, or plot.",
      hypothesis:
        "Keeping the original beside the controlled rewrite makes the effect of vocabulary density visible without losing the story that inspired the experiment.",
    },
    pages: [
      {
        id: "the-garden-gate",
        artworkPrompt: "Pip meets Flicker beside an open garden gate at sunset",
        text:
