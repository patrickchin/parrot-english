        ...
        {activeTab === "generate" ? (
          ...
          >
            ...
            {scriptText ? (
              ...
              >
                <summary className="min-h-11 cursor-pointer py-2 font-black text-brand-navy focus-visible:outline-4 focus-visible:outline-offset-4 focus-visible:outline-brand-ink">
