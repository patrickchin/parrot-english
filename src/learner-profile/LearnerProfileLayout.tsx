...
export function LearnerProfileStepHeading({
  ...
  return (
    <h1
      {...props}
      className={cx(
        "relative outline-none before:absolute before:top-0 before:-left-2 before:h-full before:max-h-24 before:w-1 before:content-[''] focus:before:bg-brand-blue forced-colors:before:hidden forced-colors:focus:outline-2 forced-colors:focus:outline-solid forced-colors:focus:outline-offset-2",
        className,
      )}
      ref={headingRef}
      tabIndex={-1}
