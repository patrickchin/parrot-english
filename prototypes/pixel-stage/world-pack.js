...
const renderProfile = Object.freeze({
  ...
  cameraSafeViewport: Object.freeze({ height: 176, width: 240 }),
  cameraZoom: 2,
  cameraZoomSteps: Object.freeze([2, 1, 0.5]),
  palette: PALETTE,
...
const holdProfiles = Object.freeze({
  ...
  "garden-shovel": hold(0.5, 0.12, 0, 2),
  kite: hold(0.5, 0.9, 4, -2),
  "teddy-bear": hold(0.34, 0.4, 2, 1),
...
const scenes = Object.freeze([
  scene({ id: "garden-party", name: "Garden Party", ground: "garden", start: { x: 430, y: 250 }, entries: [["oak-tree",150,300],["fruit-tree",610,210],["flower-patch",340,210],["bench",340,390],["hedge",90,450],["signpost",70,220],["picnic-basket",430,350]], cast: characterCast({ peppaSlotId: "center", pollySlotId: "center-right" }) }),
  scene({ id: "orchard-walk", name: "Orchard Walk", ground: "orchard", far: "hills-green", start: { x: 340, y: 350 }, entries: [["fruit-tree",120,270],["fruit-tree",330,255],["fruit-tree",600,285],["fence-short",150,455],["fence-short",560,455],["bench",470,390],["red-apple",370,330]], cast: characterCast({ peppaHeldItemId: "green-pear", pollyHeldItemId: "red-apple" }) }),
  scene({ id: "market-morning", name: "Market Morning", ground: "market", far: "village-far", start: { x: 250, y: 380 }, entries: [["market-stall",160,330],["market-stall",560,330],["lamp-post",400,350],["bench",360,425],["signpost",70,420],["picnic-basket",520,410],["wrapped-gift",215,365]], cast: characterCast({ peppaHeldItemId: "picnic-basket", peppaSlotId: "front-left", pollyHeldItemId: "wrapped-gift", pollySlotId: "front-center" }) }),
  scene({ id: "pond-picnic", name: "Pond Picnic", ground: "pond", far: "hills-green", start: { x: 390, y: 390 }, entries: [["pond-reeds",180,300],["pond-reeds",540,290],["oak-tree",630,280],["picnic-blanket",240,430],["rock-cluster",260,360],["tall-grass",90,410],["picnic-basket",300,440]], cast: characterCast({ peppaHeldItemId: "juice-bottle", peppaSlotId: "front-center", pollyHeldItemId: "storybook", pollySlotId: "front-right" }) }),
  scene({ id: "kite-meadow", name: "Kite Meadow", ground: "meadow", cloud: "clouds-soft", far: "hills-green", start: { x: 350, y: 330 }, entries: [["pine-tree",90,280],["pine-tree",650,300],["round-bush",210,390],["round-bush",560,420],["flower-patch",380,220],["fallen-log",140,440],["kite",440,370]], cast: characterCast({ peppaEmote: "happy", peppaHeldItemId: "kite", pollyHeldItemId: "garden-flower" }) }),
