...
const scenes = Object.freeze([
  ...
  scene({ id: "lesson-peppas-high-ball", name: "Lesson: Peppa's High Ball", ground: "garden", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "peppas-high-ball" }, entries: [["oak-tree",150,300],["red-ball",230,210],["hedge",620,430],["flower-patch",360,240],["bench",500,400],["signpost",70,230]], cast: characterCast({ peppaEmote: "surprised", peppaHeldItemId: null, peppaSlotId: "center-left", pollyEmote: "talking", pollyHeldItemId: "red-ball", pollySlotId: "center-right" }) }),
  scene({ id: "lesson-garden-colors", name: "Lesson: Garden Colors", ground: "garden", far: "hills-green", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "garden-colors" }, entries: [["flower-patch",170,230],["flower-patch",540,250],["round-bush",90,410],["fruit-tree",650,280],["watering-can",330,400],["garden-flower",430,360]], cast: characterCast({ peppaEmote: "happy", peppaHeldItemId: "garden-flower", peppaSlotId: "center-left", pollyHeldItemId: "paint-brush", pollySlotId: "center-right" }) }),
  scene({ id: "lesson-snack-time", name: "Lesson: Snack Time", ground: "orchard", far: "hills-green", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "snack-time" }, entries: [["fruit-tree",100,280],["fruit-tree",630,275],["picnic-blanket",360,430],["picnic-basket",270,410],["red-apple",420,390],["green-pear",480,400]], cast: characterCast({ peppaHeldItemId: "red-apple", peppaSlotId: "front-left", pollyEmote: "talking", pollyHeldItemId: "banana", pollySlotId: "front-right" }) }),
  scene({ id: "lesson-playground-words", name: "Lesson: Playground Words", ground: "playground", far: "village-far", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "playground-words" }, entries: [["playground-slide",160,350],["swing-set",550,330],["bench",360,435],["fence-short",90,465],["fence-short",630,465],["red-ball",410,380]], cast: characterCast({ peppaEmote: "talking", peppaHeldItemId: "red-ball", peppaSlotId: "center-left", pollyHeldItemId: "kite", pollySlotId: "center-right" }) }),
  scene({ id: "lesson-market-day", name: "Lesson: Market Day", ground: "market", far: "village-far", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "market-day" }, entries: [["market-stall",145,330],["market-stall",575,330],["lamp-post",360,330],["picnic-basket",270,415],["red-apple",440,390],["carrot",500,400]], cast: characterCast({ peppaHeldItemId: "picnic-basket", peppaSlotId: "front-left", pollyEmote: "talking", pollyHeldItemId: "carrot", pollySlotId: "front-right" }) }),
  scene({ id: "lesson-picnic-time", name: "Lesson: Picnic Time", ground: "pond", far: "hills-green", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "picnic-time" }, entries: [["pond-reeds",120,300],["pond-reeds",610,300],["picnic-blanket",360,430],["picnic-basket",280,415],["juice-bottle",440,390],["storybook",500,410]], cast: characterCast({ peppaHeldItemId: "juice-bottle", peppaSlotId: "front-left", pollyHeldItemId: "storybook", pollySlotId: "front-right" }) }),
  scene({ id: "lesson-bedtime-story", name: "Lesson: Bedtime Story", ground: "village", sky: "sky-sunset", cloud: "clouds-soft", far: "village-far", start: { x: 360, y: 335 }, source: { kind: "lesson", id: "bedtime-story" }, entries: [["lamp-post",100,330],["lamp-post",620,330],["bench",360,410],["flower-patch",220,430],["flower-patch",500,430],["lantern",450,390]], cast: characterCast({ peppaEmote: "talking", peppaHeldItemId: "storybook", peppaSlotId: "center-left", pollyHeldItemId: "lantern", pollySlotId: "center-right" }) }),

  scene({ id: "story-red-ball", name: "Story: Red Ball", ground: "playground", far: "village-far", start: { x: 360, y: 335 }, source: { kind: "story", id: "red-ball" }, entries: [["playground-slide",160,350],["swing-set",560,330],["bench",350,435],["oak-tree",670,280],["red-ball",420,370],["flower-patch",260,230]], cast: characterCast({ peppaEmote: "happy", peppaHeldItemId: "red-ball", peppaSlotId: "center-left", pollyEmote: "talking", pollySlotId: "center-right" }) }),
  ...
  scene({ id: "story-snack-for-two", name: "Story: Snack for Two", ground: "pond", far: "hills-green", start: { x: 360, y: 335 }, source: { kind: "story", id: "snack-for-two" }, entries: [["pond-reeds",120,300],["pond-reeds",610,300],["picnic-blanket",360,430],["picnic-basket",290,410],["red-apple",430,390],["banana",500,400]], cast: characterCast({ peppaHeldItemId: "red-apple", peppaSlotId: "front-left", pollyHeldItemId: "banana", pollySlotId: "front-right" }) }),
]);
