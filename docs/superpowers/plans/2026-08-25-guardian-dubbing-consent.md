...
> **v2 integration note:** This plan was originally written beside the
> pre-v2 feature branch. Current API examples and learner counts below use the
> integrated 24-line `five-little-ducks-v2` contract. References to the old v1
> storage namespace are historical legacy-cleanup concerns only.
...
- Produces: consent route `PUT /api/dubs/five-little-ducks-v2/consent`.
