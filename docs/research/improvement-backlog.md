...
| 9 | **Bounded conversation safety evaluation.** If scripted ordinary-child and adversarial cases verify topic, disclosure, dependency, and stop boundaries, character chat can be treated as practice rather than assumed safe. | 5 | 4 | 5 | 3 | 1 | 18 | Prompt/provider inventory; test data and evaluation design; `codex/bounded-conversation-eval` | Versioned cases and pass criteria; failures reproducible; release rollback switch documented |
